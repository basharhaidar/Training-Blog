        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('index.section')}}"> <i class="fa  fa-th"></i>  section </a>
                    </li>
                    @endif

                    <li>
                        <a href="{{route('index.image')}}"> <i class="fa fa-image"></i>  image </a>
                    </li>


                    <li>
                        <a href="{{route('index.post')}}"> <i class="fa fa-building-o"></i>  post </a>
                    </li>
